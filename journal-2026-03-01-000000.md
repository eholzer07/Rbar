...
### Committed & Pushed
- Committed 17 files (709 insertions) as "Chunk 5: Authentication & user profiles — email/password auth, sign-in/up pages, profile"
- Pushed to `main` on GitHub (eholzer07/Rbar)
